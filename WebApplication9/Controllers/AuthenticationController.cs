...
namespace WebApplication9.Controllers
{
	...
	public class AuthenticationController : ControllerBase
	{
		...
		public class WebApplication9User
		{
		...
		private WebApplication9User ValidateUserCredentials(string? userName, string? password)
		{
			...
			return new WebApplication9User(
				1,
				userName ?? "",
				"Kevin",
				"Dockx",
